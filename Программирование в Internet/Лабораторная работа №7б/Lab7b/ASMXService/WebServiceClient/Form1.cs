...
namespace WebServiceClient
{
    public partial class Form1 : Form
    {
        ...
        private ServiceReference.CollectionManagerServiceSoapClient _client;
        ...
        public Form1()
        {
            ...
            _client = new ServiceReference.CollectionManagerServiceSoapClient();
        ...
        {
            var record = new ServiceReference.PhoneRecord();
            record.Id = _idToDelete;
            _client.DeleteElement(record);
